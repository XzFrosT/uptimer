...
module.exports.run = async (client, message) => {
    ...
    if (command.botPermission) {
      ...
      if (neededPerms.length)
        return message.channel.send(`I need ${neededPerms.join(", ")} permission(s) to run this command!`);
      ...
      if (neededPerms.length)
        return message.channel.send(`You need ${neededPerms.join(", ")} permission(s) to run this command!`);
    }
